...
const PengajuanRuanganUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    data.append(
      "tanggalPeminjaman",
      formData.tanggalPeminjaman
        ? format(formData.tanggalPeminjaman, "yyyy-MM-dd")
        : ""
    );
    data.append(
      "tanggalSelesai",
      formData.tanggalSelesai
        ? format(formData.tanggalSelesai, "yyyy-MM-dd")
        : ""
    );
    data.append("lampiran", formData.lampiran);

    try {
      const response = await peminjamanRuanganService.createPeminjamanRuangan(
        idRuangan,
        data
      );
