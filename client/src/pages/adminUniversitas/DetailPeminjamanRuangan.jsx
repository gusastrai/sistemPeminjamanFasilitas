      ...
      <CardContent className="space-y-8">
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="grid grid-cols-2 gap-4">
            <p>
              <span className="font-medium">Nama:</span> {peminjaman.user.nama}
            </p>
            <p>
              <span className="font-medium">NIM/NIP:</span>{" "}
              {peminjaman.user.nomorInduk}
            </p>
            <p>
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {peminjaman.dokumen &&
              peminjaman.dokumen.map((dok, index) => (
